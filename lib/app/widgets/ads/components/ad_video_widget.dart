...
class AdVideoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final videoId = campaign.media.videos.isNotEmpty ? campaign.media.videos.first : '';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ClipRRect(
            borderRadius: const BorderRadius.vertical(top: Radius.circular(_Constants.borderRadius)),
            child: AspectRatio(
              aspectRatio: _Constants.videoAspectRatio,
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      if (campaign.content.badge != null && campaign.content.badge!.isNotEmpty) ...[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(_Constants.badgeRadius),
                          ),
                          child: Text(
                ...
                const Gap(12),
                if (campaign.content.ctaLabel != null && campaign.content.ctaLabel!.isNotEmpty)
                  ElevatedButton(
                    onPressed: () => AdActionHandler.handleAdAction(context, campaign),
