...
class SmallResidenceCard extends StatefulWidget {
  const SmallResidenceCard({super.key, required this.residenceModel});
...
class _SmallResidenceCardState extends State<SmallResidenceCard> {
  ...
  @override
  void initState() {
    favoriesUtils.isFavorite(widget.residenceModel.id).then(
      (value) {
        _liked.value = value;
      },
    );
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      bottom: 10,
                      child: CustomChip(
                        label: widget.residenceModel.typeResidence,
