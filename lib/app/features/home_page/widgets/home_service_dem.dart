...
// class HomeServiceDem extends StatelessWidget {
//   const HomeServiceDem({Key? key}) : super(key: key);

//   @override
//   Widget build(BuildContext context) {
//     return BlocBuilder<ProductCubit, AppState>(
//       buildWhen: (previous, current) =>
//           current is PendingState<DemServiceState> ||
//           current is DoneState<DemServiceState>,
//       builder: (context, state) {
//         return SliverToBoxAdapter(
//           child: (state is DoneState<DemServiceState>)
