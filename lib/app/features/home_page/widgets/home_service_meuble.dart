...
// class HomeServiceMeuble extends StatelessWidget {
//   const HomeServiceMeuble({Key? key}) : super(key: key);

//   @override
//   Widget build(BuildContext context) {
//     return BlocBuilder<ProductCubit, AppState>(
//       buildWhen: (previous, current) =>
//           current is PendingState<MeubleServiceState> ||
//           current is DoneState<MeubleServiceState>,
//       builder: (context, state) {
//         return SliverToBoxAdapter(
//           child: (state is DoneState<MeubleServiceState>)
