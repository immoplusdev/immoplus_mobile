...
// class HomeServiceProp extends StatelessWidget {
//   const HomeServiceProp({Key? key}) : super(key: key);

//   @override
//   Widget build(BuildContext context) {
//     return BlocBuilder<ProductCubit, AppState>(
//       buildWhen: (previous, current) =>
//           current is PendingState<AchatPropriServiceState> ||
//           current is DoneState<AchatPropriServiceState>,
//       builder: (context, state) {
//         return SliverToBoxAdapter(
//           child: (state is DoneState<AchatPropriServiceState>)
